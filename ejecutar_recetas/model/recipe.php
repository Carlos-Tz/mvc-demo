...
class Recipe {
    ...
    public function getAll() {
        ...
        $stmt = $this->Connection->prepare("SELECT receta.id_receta, receta.num_subrancho, receta.fecha, receta.status, receta.justificacion, subrancho.nombre as nombre FROM receta, subrancho WHERE (receta.num_subrancho = subrancho.num_subrancho)  AND receta.status = 'Entregada'" );
        $stmt->execute();
