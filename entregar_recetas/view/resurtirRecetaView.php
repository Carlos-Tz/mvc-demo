        ...
        <div class="row py-2 px-2" style="background-color: #e3e6ec">
            <div class="col-md-4 ">
                <div class="form-group">
                    ...
                    <textarea name="encargado" id="" rows="2" class="form-control" style="resize: none;" required><?php echo $data['receta'][0]['encargado'] ?></textarea>
                </div>
            </div>
            <div class="col-md-4 ">
                <div class="form-group">
                    <label for="sub">Equipo de aplicación:</label>
                    <textarea name="equipo" id="" rows="2" class="form-control" style="resize: none;" required><?php echo $data['receta'][0]['equipo'] ?></textarea>
                </div>
            </div>
            <div class="col-md-4 ">
                <div class="form-group">
                    <label for="sub">Justificación:</label>
                    <textarea name="justificacion" id="" rows="2" class="form-control" style="resize: none;" required><?php echo $data['receta'][0]['justificacion'] ?></textarea>
                </div>
            </div>
        </div>
